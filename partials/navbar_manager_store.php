<nav class="navbar w3-black w3-card">
    ...
    <div class="w3-bar w3-white w3-card  w3-monospace w3-margin">
        ...
        <a href="add_book.php" class="w3-bar-item w3-button">Add New Book</a>
        <a href="out_of_stock.php" class="w3-bar-item w3-button">Out of Stock</a>
        <a href="import.php" class="w3-bar-item w3-button">History of Stock Imported</a>
